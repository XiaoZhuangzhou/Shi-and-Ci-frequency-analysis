# -*- coding:utf-8 -*-
import draw_a_bar
txt = open('shi300res.txt','r',encoding= 'gbk').read()
...
for i in range(1,len(txt)):
  if txt[i] in ['\n','\u3000'] or txt[i] in "：:0123456789ABCDEFGqwertyuiopasdfghjklzxcvbnm_=（）,， *().。+":
    continue
  if txt[i+1] in ['\n','\u3000'] or txt[i+1] in "01234：:56789ABCDEFGqwertyuiopasdfghjklzxcvbnm_=（）,， *().。+":
    continue
